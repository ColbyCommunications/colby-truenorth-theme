                      ...
                      <div class="">
                        ...
                        <div style="color:<?php echo $notificaiton_font_color; ?>;line-height:120%;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif; padding-right: 0px; padding-left: 0px; padding-top: 20px; padding-bottom: 20px;">
                          <div style="font-size:12px;line-height:14px;color:<?php echo $notificaiton_font_color; ?>;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                            ...
                            <p>Thank you for registering on <strong><?php echo $blogname; ?></strong></p>
                            <p>Your email address to login in with is <strong><?php echo $user_email; ?></strong>. For security reasons, we encrypted your password will not share it with anyone. If at any time you forget your password, you can always reset it.</p>
                            <p>You can login by going here: <strong><a href="<?php echo site_url(); ?>/account"><?php echo site_url(); ?>/account</a></strong></p>
                            <p>Thanks!</p>
                          </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->

                      ...
                      <div class="">
                        ...
                        <div style="color:<?php echo $notificaiton_font_color; ?>;line-height:120%;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif; padding-right: 0px; padding-left: 0px; padding-top: 20px; padding-bottom: 20px;">
                          <div style="font-size:12px;line-height:14px;color:<?php echo $notificaiton_font_color; ?>;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                            ...
                            <p>You asked us to reset your password for your account using the email address <strong><?php echo $user_login; ?></strong></p>
                            <p>If this was a mistake, or you didn't ask for a password reset, just ignore this email and nothing will happen.</p>
                            <p><strong>To reset your password, visit the following address:</strong></p>
                            <p><a href="<?php echo site_url( "account/password-reset?key=$key&login=" . rawurlencode( $user_login ), 'login' ); ?>"><?php echo site_url( "account/password-reset?key=$key&login=" . rawurlencode( $user_login ), 'login' ); ?></a></p>
                            <p>Thanks!</p>
                          </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->

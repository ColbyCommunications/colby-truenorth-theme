<?php
  $notification_background_color = (get_field('brand_background_color', 'option')) ? get_field('brand_background_color', 'option') : "#f6f7f8";
  $notification_border_color = (get_field('brand_border_color', 'option')) ? get_field('brand_border_color', 'option') : "#e5e6eb";
  $notificaiton_font_color = (get_field('brand_font_color', 'option')) ? get_field('brand_font_color', 'option') : "#111C38";
  $notification_logo = (get_field('brand_logo', 'option')) ? get_field('brand_logo', 'option')['url'] : "https://www.antennagroup.com/wp-content/uploads/antenna_logo.png";
?>
...
<body class="clean-body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: <?php echo $notification_background_color; ?>">
  ...
  <table class="nl-container" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: <?php echo $notification_background_color; ?>;width: 100%" cellpadding="0"
    cellspacing="0">
    <tbody>
      <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
          <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="background-color: <?php echo $notification_background_color; ?>;"><![endif]-->
                          ...
                          <tr style="vertical-align: top">
                            <td class="divider_inner" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top;padding-right: 10px;padding-left: 10px;padding-top: 10px;padding-bottom: 10px;min-width: 100%;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
                              <table class="divider_content" height="10px" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;border-top: 0px solid transparent;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
                                <tbody>
                                  <tr style="vertical-align: top">
                                    <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top;font-size: 10px;line-height: 10px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%"> <span>&#160;</span> </td>
                                  </tr>
                                </tbody>
                              </table>
                            </td>
          ...
          <div style="background-color:transparent;">
            <div style="Margin: 0 auto;min-width: 320px;max-width: 500px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #fff;" class="block-grid ">
              <div style="border-collapse: collapse;display: table;width: 100%;background-color:#fff;">
                ...
                <!--[if (mso)|(IE)]><td align="center" width="498" style=" width:498px; padding-right: 25px; padding-left: 25px; padding-top:30px; padding-bottom:40px; border-top: 1px solid <?php echo $notification_border_color; ?>; border-left: 1px solid <?php echo $notification_border_color; ?>; border-bottom: 1px solid <?php echo $notification_border_color; ?>; border-right: 1px solid <?php echo $notification_border_color; ?>;" valign="top"><![endif]-->
                <div class="col num12" style="min-width: 320px;max-width: 500px;display: table-cell;vertical-align: top;">
                  <div style="background-color: transparent; width: 100% !important;">
                    <!--[if (!mso)&(!IE)]><!-->
                    <div style="border-top: 1px solid <?php echo $notification_border_color; ?>; border-left: 1px solid <?php echo $notification_border_color; ?>; border-bottom: 1px solid <?php echo $notification_border_color; ?>; border-right: 1px solid <?php echo $notification_border_color; ?>; padding-top:30px; padding-bottom:40px; padding-right: 25px; padding-left: 25px;">
                      <!--<![endif]-->
                      <div align="left" class="img-container left  autowidth  " style="padding-right: 0px;  padding-left: 0px;">
                        ...
                        <div style="line-height:15px;font-size:1px">&#160;</div> <img class="left  autowidth " align="left" border="0" src="<?php echo $notification_logo; ?>" alt="<?php the_field('name', 'option'); ?> Logo" title="<?php the_field('name', 'option'); ?> Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 300px"
                          width="300">
                        <div style="line-height:15px;font-size:1px">&#160;</div>
                        <!--[if mso]></td></tr></table><![endif]-->
                      </div>
                      <div class="">
                        <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px; padding-top: 25px; padding-bottom: 25px;"><![endif]-->
                        <div style="color:<?php echo $notificaiton_font_color; ?>;line-height:120%;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif; padding-right: 0px; padding-left: 0px; padding-top: 25px; padding-bottom: 25px;">
                          <div style="font-size:12px;line-height:14px;color:<?php echo $notificaiton_font_color; ?>;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                            <p style="margin: 0;font-size: 14px;line-height: 17px"><strong><span style="font-size: 18px; line-height: 21px;">Notification - {form_title}</span></strong></p>
                            <p style="margin: 0;font-size: 14px;line-height: 17px">&#160; <br> </p>
                            <p style="margin: 0;font-size: 14px;line-height: 17px"><span style="font-size: 12px; line-height: 14px;">Notification from: {entry_url}</span></p>
                          </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                      </div>
                      <div class="">
                        ...
                        <div style="color:<?php echo $notificaiton_font_color; ?>;line-height:120%;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif; padding-right: 0px; padding-left: 0px; padding-top: 20px; padding-bottom: 20px;">
                          <div style="font-size:12px;line-height:14px;color:<?php echo $notificaiton_font_color; ?>;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                            <p style="margin: 0;font-size: 14px;line-height: 17px"><strong>Form Submission Summary:</strong></p>
                            <p style="margin: 0;font-size: 14px;line-height: 17px"> <br data-mce-bogus="1"> </p>
                            <p style="margin: 0;font-size: 14px;line-height: 17px">{all_fields} <br> </p>
                          </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                      </div>

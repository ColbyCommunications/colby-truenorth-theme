  ...
  <div class="row row-site column">
    <div class="northward-values">
      <div class="northward-values__col northward-values__col--logo">
        <a href="/discover"><img src="<?php echo get_sub_field('logo')['url']; ?>" width="<?php echo get_sub_field('logo')['width']; ?>" height="<?php echo get_sub_field('logo')['height']; ?>" alt="<?php echo esc_attr(get_sub_field('logo')['alt']); ?>" /></a>
      </div>
